This is a non-blocking (no use of delay) LCD library for use with sparkfun displays that use SerLCD library. Named SerLCD0 with the 0 for no use of delay and no blocking. 
